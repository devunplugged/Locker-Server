...
class PackageModel extends Model
{
    ...
    protected $allowedFields    = ['id_hash', 'code', 'size', 'recipient_email', 'recipient_phone', 'recipient_code', 'status', 'locker_id', 'cell_sort_id', 'company_id', 'created_by', 'enter_code_entered_at', 'recipient_code_entered_at', 'inserted_at', 'removed_at'];
   ...
   /* public function getActivePackageByRecipientCode($code){
    ...
    public function getInsertOrRemoveReadyPackagesForCell($lockerId, $cellSortId){
        return $this->where('locker_id', $lockerId)->where('cell_sort_id', $cellSortId)->groupStart()->where('status', 'insert-ready')->orWhere('status', 'remove-ready')->groupEnd()->findAll();
    }
